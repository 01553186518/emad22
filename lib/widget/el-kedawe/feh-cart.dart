...
class fishcart1 extends StatefulWidget {
  const fishcart1({Key? key}) : super(key: key);

  @override
  State<fishcart1> createState() => _fishcart1State();
}

class _fishcart1State extends State<fishcart1> {
  int count = 0;
