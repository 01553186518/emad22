...
class fishcart12 extends StatefulWidget {
  const fishcart12({Key? key}) : super(key: key);

  @override
  State<fishcart12> createState() => _fishcart12State();
}

class _fishcart12State extends State<fishcart12> {
  int count = 0;
