...
class fishcart3 extends StatefulWidget {
  const fishcart3({Key? key}) : super(key: key);

  @override
  State<fishcart3> createState() => _fishcart3State();
}

class _fishcart3State extends State<fishcart3> {
  int count = 0;
