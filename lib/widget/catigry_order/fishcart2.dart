...
class fishcart2 extends StatefulWidget {
  const fishcart2({Key? key}) : super(key: key);

  @override
  State<fishcart2> createState() => _fishcart2State();
}

class _fishcart2State extends State<fishcart2> {
  int count = 0;
