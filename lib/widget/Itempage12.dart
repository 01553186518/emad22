...
class Itempage12 extends StatefulWidget {
  const Itempage12({Key? key}) : super(key: key);

  @override
  State<Itempage12> createState() => _Itempage12State();
}

class _Itempage12State extends State<Itempage12> {
  int count = 0;
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  NetworkImage("https://firebasestorage.googleapis.com/v0/b/restruntapp-849ba.appspot.com/o/Burger-Transparent-Images.png?alt=media&token=391a993d-a1e9-4492-b337-f14bdb6f02cc"),
