...
class Popular2Itempage extends StatefulWidget {
  const Popular2Itempage({Key? key}) : super(key: key);

  @override
  State<Popular2Itempage> createState() => _Popular2ItempageState();
}

class _Popular2ItempageState extends State<Popular2Itempage> {
  int count = 0;
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  NetworkImage("https://firebasestorage.googleapis.com/v0/b/restruntapp-849ba.appspot.com/o/prodect%2Ffeshig%2Fdownload%20(1).jpg?alt=media&token=1465c00b-2860-4f14-9f24-d625d8ca547c",)
