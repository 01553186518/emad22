...
class Popular8Itempage extends StatefulWidget {
  const Popular8Itempage({Key? key}) : super(key: key);

  @override
  State<Popular8Itempage> createState() => _Popular8ItempageState();
}

class _Popular8ItempageState extends State<Popular8Itempage> {
  int count = 0;
