...
class Popular7Itempage extends StatefulWidget {
  const Popular7Itempage({Key? key}) : super(key: key);

  @override
  State<Popular7Itempage> createState() => _Popular7ItempageState();
}

class _Popular7ItempageState extends State<Popular7Itempage> {
  int count = 0;
