...
class Popular3itemcat extends StatefulWidget {
  const Popular3itemcat({Key? key}) : super(key: key);

  @override
  State<Popular3itemcat> createState() => _Popular3itemcatState();
}

class _Popular3itemcatState extends State<Popular3itemcat> {
  int count = 0;
